...
ActiveRecord::Schema[8.1].define(version: 2026_09_14_160000) do
  ...
  create_table "borrowings", force: :cascade do |t|
    ...
    t.datetime "due_today_reminder_sent_at"
    t.bigint "reader_id", null: false
    t.datetime "returned_at"
    t.datetime "updated_at", null: false
    t.index ["book_id"], name: "index_borrowings_on_book_id"
    t.index ["book_id"], name: "index_borrowings_on_open_book", unique: true, where: "(returned_at IS NULL)"
  ...
  create_table "readers", force: :cascade do |t|
    ...
    t.datetime "updated_at", null: false
    t.index "lower((email)::text)", name: "index_readers_on_lower_email", unique: true
